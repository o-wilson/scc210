...
public class Obstacle {
    ...
    public enum ObstacleType {
        ...
        DOG_1(11, 4, 5, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        DOG_2(12, 2, 5, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        CAT(13, 2, 5, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        PIG(14, 2, 8, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        CONE(15, 1, 1, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.YELLOW}),
        BARRIER(16, 2, 10, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.YELLOW}),
        SIGN_1(17, 1, 1, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.DIRT}),
        SIGN_2(18, 1, 1, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.DIRT}),
        ROCK_1(19, 1, 1, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        ROCK_2(20, 1, 1, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        TREE_1(21, 4, 5, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        TREE_2(22, 4, 7, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        TREE_3(23, 4, 10, 0, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        TRUCK_1(11, 2, 7, 60, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.WHITE}),
        TRUCK_2(11, 2, 7, 60, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.DIRT}),
        TRUCK_3(11, 4, 7, 60, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.DIRT}),
        TRUCK_4(11, 2, 7, 60, new FloatRect(0, 0, 32, 32), new RoadSection[] {RoadSection.DIRT}),
        ;
